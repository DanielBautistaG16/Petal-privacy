...
public class b4xinputtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "anywheresoftware.b4a.samples.gps.b4xinputtemplate");
            if (htSubs == null) {
...
public ResumableSub_Show(anywheresoftware.b4a.samples.gps.b4xinputtemplate parent,anywheresoftware.b4a.samples.gps.b4xdialog _dialog) {
this.parent = parent;
