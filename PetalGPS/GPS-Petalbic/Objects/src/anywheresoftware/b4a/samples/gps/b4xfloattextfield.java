...
public class b4xfloattextfield extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "anywheresoftware.b4a.samples.gps.b4xfloattextfield");
            if (htSubs == null) {
...
public anywheresoftware.b4a.samples.gps.b4xfloattextfield  _getnextfield() throws Exception{
...
if (_mnexttextfield.IsInitialized /*boolean*/ ()==__c.False || (_mnexttextfield).equals((anywheresoftware.b4a.samples.gps.b4xfloattextfield)(this))) { 
...
public String  _setnextfield(anywheresoftware.b4a.samples.gps.b4xfloattextfield _field) throws Exception{
...
_mnexttextfield = (anywheresoftware.b4a.samples.gps.b4xfloattextfield)(_o);
...
public ResumableSub_SwitchFromPasswordToRegular(anywheresoftware.b4a.samples.gps.b4xfloattextfield parent,boolean _toregular) {
this.parent = parent;
...
if (_mnexttextfield.IsInitialized /*boolean*/ () && (_mnexttextfield).equals((anywheresoftware.b4a.samples.gps.b4xfloattextfield)(this)) == false) { 
