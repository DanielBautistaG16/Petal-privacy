...
public class b4xloadingindicator extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "anywheresoftware.b4a.samples.gps.b4xloadingindicator");
            if (htSubs == null) {
...
public ResumableSub_MainLoop(anywheresoftware.b4a.samples.gps.b4xloadingindicator parent) {
this.parent = parent;
}
