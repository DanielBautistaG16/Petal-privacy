...
public class anotherprogressbar extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "anywheresoftware.b4a.samples.gps.anotherprogressbar");
            if (htSubs == null) {
...
public ResumableSub_BusyLoop(anywheresoftware.b4a.samples.gps.anotherprogressbar parent) {
this.parent = parent;
}
