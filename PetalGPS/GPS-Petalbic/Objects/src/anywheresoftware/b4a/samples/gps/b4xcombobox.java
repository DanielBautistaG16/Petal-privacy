...
public class b4xcombobox extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "anywheresoftware.b4a.samples.gps.b4xcombobox");
            if (htSubs == null) {
...
public ResumableSub_RaiseEvent(anywheresoftware.b4a.samples.gps.b4xcombobox parent) {
this.parent = parent;
}
