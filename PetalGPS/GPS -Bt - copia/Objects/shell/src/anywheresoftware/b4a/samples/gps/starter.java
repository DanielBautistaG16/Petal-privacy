...
public boolean isSingleton() {
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("starter"), "anywheresoftware.b4a.samples.gps.starter");
	}
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
        ...
        remoteMe = RemoteObject.declareNull("anywheresoftware.b4a.samples.gps.starter");
...
public static anywheresoftware.b4a.samples.gps.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"admin",starter._admin,"ast",starter._ast,"connected",starter._connected,"connecting",starter._connecting,"DateUtils",starter.mostCurrent._dateutils,"Main",Debug.moduleToString(anywheresoftware.b4a.samples.gps.main.class),"serial",starter._serial,"Service",starter.mostCurrent._service,"XUIViewsUtils",Debug.moduleToString(anywheresoftware.b4a.samples.gps.xuiviewsutils.class)};
}
}