...
try {
		Debug.PushSubsStack("astreams_Error (asyncstreamstext) ","asyncstreamstext",1,__ref.getField(false, "ba"),__ref,54);
...
asyncstreamstext.__c.runVoidMethod ("LogImpl","21638401",RemoteObject.concat(RemoteObject.createImmutable("error: "),asyncstreamstext.__c.runMethod(false,"LastException",__ref.runMethod(false,"getActivityBA"))),0);
 BA.debugLineNum = 56;BA.debugLine="astreams.Close";
Debug.ShouldStop(8388608);
__ref.getField(false,"_astreams" /*RemoteObject*/ ).runVoidMethod ("Close");
 BA.debugLineNum = 57;BA.debugLine="CallSubDelayed(mTarget, mEventName & \"_Terminated";
Debug.ShouldStop(16777216);
asyncstreamstext.__c.runVoidMethod ("CallSubDelayed",__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_mtarget" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_Terminated"))));
...
try {
		Debug.PushSubsStack("astreams_NewData (asyncstreamstext) ","asyncstreamstext",1,__ref.getField(false, "ba"),__ref,26);
...
_newdatastart = __ref.getField(false,"_sb" /*RemoteObject*/ ).runMethod(true,"getLength");Debug.locals.put("newDataStart", _newdatastart);Debug.locals.put("newDataStart", _newdatastart);
 BA.debugLineNum = 28;BA.debugLine="sb.Append(BytesToString(Buffer, 0, Buffer.Length,";
Debug.ShouldStop(134217728);
__ref.getField(false,"_sb" /*RemoteObject*/ ).runVoidMethod ("Append",(Object)(asyncstreamstext.__c.runMethod(true,"BytesToString",(Object)(_buffer),(Object)(BA.numberCast(int.class, 0)),(Object)(_buffer.getField(true,"length")),(Object)(__ref.getField(true,"_charset" /*RemoteObject*/ )))));
 BA.debugLineNum = 29;BA.debugLine="Dim s As String = sb.ToString";
Debug.ShouldStop(268435456);
_s = __ref.getField(false,"_sb" /*RemoteObject*/ ).runMethod(true,"ToString");Debug.locals.put("s", _s);Debug.locals.put("s", _s);
...
Debug.ShouldStop(32);
asyncstreamstext.__c.runVoidMethod ("CallSubDelayed2",__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_mtarget" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_NewText"))),(Object)((_s.runMethod(true,"substring",(Object)(_start),(Object)(BA.numberCast(int.class, _i))))));
...
__ref.getField(false,"_sb" /*RemoteObject*/ ).runVoidMethod ("Remove",(Object)(BA.numberCast(int.class, 0)),(Object)(_start));};
...
try {
		Debug.PushSubsStack("astreams_Terminated (asyncstreamstext) ","asyncstreamstext",1,__ref.getField(false, "ba"),__ref,50);
...
try {
		Debug.PushSubsStack("Close (asyncstreamstext) ","asyncstreamstext",1,__ref.getField(false, "ba"),__ref,60);
...
try {
		Debug.PushSubsStack("Initialize (asyncstreamstext) ","asyncstreamstext",1,__ref.getField(false, "ba"),__ref,14);
...
__ref.setField ("_mtarget" /*RemoteObject*/ ,_targetmodule);
...
Debug.ShouldStop(65536);
__ref.getField(false,"_astreams" /*RemoteObject*/ ).runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)((_in.getObject())),(Object)((_out.getObject())),(Object)(RemoteObject.createImmutable("astreams")));
 BA.debugLineNum = 18;BA.debugLine="sb.Initialize";
Debug.ShouldStop(131072);
__ref.getField(false,"_sb" /*RemoteObject*/ ).runVoidMethod ("Initialize");
...
try {
		Debug.PushSubsStack("Write (asyncstreamstext) ","asyncstreamstext",1,__ref.getField(false, "ba"),__ref,22);
...
Debug.ShouldStop(4194304);
__ref.getField(false,"_astreams" /*RemoteObject*/ ).runVoidMethod ("Write",(Object)(_text.runMethod(false,"getBytes",(Object)(__ref.getField(true,"_charset" /*RemoteObject*/ )))));
