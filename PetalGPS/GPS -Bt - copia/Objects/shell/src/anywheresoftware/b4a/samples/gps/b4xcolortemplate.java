...
public static RemoteObject _huebar = RemoteObject.declareNull("anywheresoftware.b4a.samples.gps.b4xcolortemplate._colorpickerpart");
public static RemoteObject _colorpicker = RemoteObject.declareNull("anywheresoftware.b4a.samples.gps.b4xcolortemplate._colorpickerpart");
public static RemoteObject _alphabar = RemoteObject.declareNull("anywheresoftware.b4a.samples.gps.b4xcolortemplate._colorpickerpart");
public static RemoteObject _borderscolor = RemoteObject.createImmutable(0);
public static RemoteObject _xdialog = RemoteObject.declareNull("anywheresoftware.b4a.samples.gps.b4xdialog");
