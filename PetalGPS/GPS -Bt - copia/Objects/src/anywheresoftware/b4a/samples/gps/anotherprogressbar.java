...
public class anotherprogressbar extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new anywheresoftware.b4a.ShellBA(_ba, this, htSubs, "anywheresoftware.b4a.samples.gps.anotherprogressbar");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", anywheresoftware.b4a.samples.gps.anotherprogressbar.class).invoke(this, new Object[] {null});
        else
...
public String  _base_resize(anywheresoftware.b4a.samples.gps.anotherprogressbar __ref,double _width,double _height) throws Exception{
__ref = this;
...
RDebugUtils.currentLine=3407873;
 //BA.debugLineNum = 3407873;BA.debugLine="For Each v As B4XView In mBase.GetAllViewsRecursi";
...
RDebugUtils.currentLine=3407874;
 //BA.debugLineNum = 3407874;BA.debugLine="v.SetLayoutAnimated(0, 0, 0, Width, Height)";
_v.SetLayoutAnimated((int) (0),(int) (0),(int) (0),(int) (_width),(int) (_height));
 }
};
RDebugUtils.currentLine=3407876;
 //BA.debugLineNum = 3407876;BA.debugLine="bc.Initialize(mBase.Width / xui.Scale, mBase.Heig";
...
RDebugUtils.currentLine=3407877;
 //BA.debugLineNum = 3407877;BA.debugLine="Vertical = mBase.Height > mBase.Width";
__ref._vertical /*boolean*/  = __ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()>__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth();
RDebugUtils.currentLine=3407878;
 //BA.debugLineNum = 3407878;BA.debugLine="UpdateGraphics";
__ref._updategraphics /*String*/ (null);
RDebugUtils.currentLine=3407880;
 //BA.debugLineNum = 3407880;BA.debugLine="End Sub";
return "";
}
public String  _updategraphics(anywheresoftware.b4a.samples.gps.anotherprogressbar __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="anotherprogressbar";
...
RDebugUtils.currentLine=3670016;
 //BA.debugLineNum = 3670016;BA.debugLine="Public Sub UpdateGraphics";
RDebugUtils.currentLine=3670017;
 //BA.debugLineNum = 3670017;BA.debugLine="EmptyBrush = bc.CreateBrushFromColor(EmptyColor)";
...
RDebugUtils.currentLine=3670018;
 //BA.debugLineNum = 3670018;BA.debugLine="TransparentBrush = bc.CreateBrushFromColor(xui.Co";
...
RDebugUtils.currentLine=3670019;
 //BA.debugLineNum = 3670019;BA.debugLine="Dim Width As Int = 40";
_width = (int) (40);
RDebugUtils.currentLine=3670020;
 //BA.debugLineNum = 3670020;BA.debugLine="Dim Template As BitmapCreator";
_template = new b4a.example.bitmapcreator();
RDebugUtils.currentLine=3670021;
 //BA.debugLineNum = 3670021;BA.debugLine="Dim bcolor As ARGBColor";
_bcolor = new b4a.example.bitmapcreator._argbcolor();
RDebugUtils.currentLine=3670022;
 //BA.debugLineNum = 3670022;BA.debugLine="bc.ColorToARGB(BackgroundColor, bcolor)";
__ref._bc /*b4a.example.bitmapcreator*/ ._colortoargb(__ref._backgroundcolor /*int*/ ,_bcolor);
RDebugUtils.currentLine=3670023;
 //BA.debugLineNum = 3670023;BA.debugLine="bcolor.r = Min(255, bcolor.r * 1.5)";
_bcolor.r = (int) (__c.Min(255,_bcolor.r*1.5));
RDebugUtils.currentLine=3670024;
 //BA.debugLineNum = 3670024;BA.debugLine="bcolor.g = Min(255, bcolor.g * 1.5)";
_bcolor.g = (int) (__c.Min(255,_bcolor.g*1.5));
RDebugUtils.currentLine=3670025;
 //BA.debugLineNum = 3670025;BA.debugLine="bcolor.b = Min(255, bcolor.b * 1.5)";
_bcolor.b = (int) (__c.Min(255,_bcolor.b*1.5));
RDebugUtils.currentLine=3670026;
 //BA.debugLineNum = 3670026;BA.debugLine="If Vertical Then";
if (__ref._vertical /*boolean*/ ) { 
RDebugUtils.currentLine=3670027;
 //BA.debugLineNum = 3670027;BA.debugLine="Template.Initialize(mBase.Width / xui.Scale, mBa";
...
RDebugUtils.currentLine=3670029;
 //BA.debugLineNum = 3670029;BA.debugLine="Template.Initialize(mBase.Height / xui.Scale + W";
_template._initialize(ba,(int) (__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()/(double)__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .getScale()+_width),(int) (__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()/(double)__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .getScale()));
 };
RDebugUtils.currentLine=3670032;
 //BA.debugLineNum = 3670032;BA.debugLine="Template.DrawRect(Template.TargetRect, Background";
_template._drawrect(_template._targetrect,__ref._backgroundcolor /*int*/ ,__c.True,(int) (0));
RDebugUtils.currentLine=3670033;
 //BA.debugLineNum = 3670033;BA.debugLine="If Vertical Then";
if (__ref._vertical /*boolean*/ ) { 
RDebugUtils.currentLine=3670034;
 //BA.debugLineNum = 3670034;BA.debugLine="Template.DrawLine(-Width / 2, Width / 2, Templat";
...
RDebugUtils.currentLine=3670036;
 //BA.debugLineNum = 3670036;BA.debugLine="Template.DrawLine(Width / 2, -Width / 2, Templat";
_template._drawline((float) (_width/(double)2),(float) (-_width/(double)2),(float) (_template._mwidth-_width/(double)2),(float) (_template._mheight+_width/(double)2),__ref._bc /*b4a.example.bitmapcreator*/ ._argbtocolor(_bcolor),_width);
 };
RDebugUtils.currentLine=3670038;
 //BA.debugLineNum = 3670038;BA.debugLine="BusyBrush = bc.CreateBrushFromBitmapCreator(Templ";
...
RDebugUtils.currentLine=3670039;
 //BA.debugLineNum = 3670039;BA.debugLine="If mValue = 100 Then";
if (__ref._mvalue /*int*/ ==100) { 
RDebugUtils.currentLine=3670040;
 //BA.debugLineNum = 3670040;BA.debugLine="bc.DrawRectRounded(bc.TargetRect, BackgroundColo";
...
RDebugUtils.currentLine=3670042;
 //BA.debugLineNum = 3670042;BA.debugLine="bc.DrawRectRounded2(bc.TargetRect, EmptyBrush, T";
...
RDebugUtils.currentLine=3670044;
 //BA.debugLineNum = 3670044;BA.debugLine="bc.SetBitmapToImageView(bc.Bitmap, mIV)";
...
RDebugUtils.currentLine=3670045;
 //BA.debugLineNum = 3670045;BA.debugLine="setVisible(mBase.Visible)";
...
public void  _busyloop(anywheresoftware.b4a.samples.gps.anotherprogressbar __ref) throws Exception{
RDebugUtils.currentModule="anotherprogressbar";
...
public ResumableSub_BusyLoop(anywheresoftware.b4a.samples.gps.anotherprogressbar parent,anywheresoftware.b4a.samples.gps.anotherprogressbar __ref) {
this.parent = parent;
this.__ref = __ref;
this.__ref = parent;
}
anywheresoftware.b4a.samples.gps.anotherprogressbar __ref;
anywheresoftware.b4a.samples.gps.anotherprogressbar parent;
int _myindex = 0;
...
RDebugUtils.currentLine=3473409;
 //BA.debugLineNum = 3473409;BA.debugLine="Dim MyIndex As Int = BusyIndex";
_myindex = __ref._busyindex /*int*/ ;
RDebugUtils.currentLine=3473410;
 //BA.debugLineNum = 3473410;BA.debugLine="Dim r As B4XRect";
_r = new anywheresoftware.b4a.objects.B4XCanvas.B4XRect();
RDebugUtils.currentLine=3473411;
 //BA.debugLineNum = 3473411;BA.debugLine="r.Initialize(0, 0, bc.mWidth, bc.mHeight)";
...
RDebugUtils.currentLine=3473412;
 //BA.debugLineNum = 3473412;BA.debugLine="Dim LastTime As Long = DateTime.Now";
_lasttime = parent.__c.DateTime.getNow();
RDebugUtils.currentLine=3473413;
 //BA.debugLineNum = 3473413;BA.debugLine="Do While MyIndex = BusyIndex";
if (true) break;
...
RDebugUtils.currentLine=3473414;
 //BA.debugLineNum = 3473414;BA.debugLine="If Vertical Then";
if (true) break;
...
RDebugUtils.currentLine=3473415;
 //BA.debugLineNum = 3473415;BA.debugLine="BusyBrush.SrcOffsetY = BusyBrush.SrcOffsetY + B";
...
RDebugUtils.currentLine=3473417;
 //BA.debugLineNum = 3473417;BA.debugLine="BusyBrush.SrcOffsetX = BusyBrush.SrcOffsetX + B";
...
RDebugUtils.currentLine=3473419;
 //BA.debugLineNum = 3473419;BA.debugLine="Dim tasks As List";
_tasks = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=3473420;
 //BA.debugLineNum = 3473420;BA.debugLine="tasks.Initialize";
_tasks.Initialize();
RDebugUtils.currentLine=3473421;
 //BA.debugLineNum = 3473421;BA.debugLine="tasks.Add(bc.AsyncDrawRect(bc.TargetRect, Transp";
...
RDebugUtils.currentLine=3473422;
 //BA.debugLineNum = 3473422;BA.debugLine="Dim delta As Float = mValue - CurrentValue";
_delta = (float) (__ref._mvalue /*int*/ -__ref._currentvalue /*float*/ );
RDebugUtils.currentLine=3473423;
 //BA.debugLineNum = 3473423;BA.debugLine="If Abs(delta) <= 1 Then";
if (true) break;
...
RDebugUtils.currentLine=3473424;
 //BA.debugLineNum = 3473424;BA.debugLine="CurrentValue = mValue";
...
RDebugUtils.currentLine=3473426;
 //BA.debugLineNum = 3473426;BA.debugLine="Dim change As Float = (DateTime.Now - LastTime)";
...
RDebugUtils.currentLine=3473427;
 //BA.debugLineNum = 3473427;BA.debugLine="If delta > 0 Then";
if (true) break;
...
RDebugUtils.currentLine=3473428;
 //BA.debugLineNum = 3473428;BA.debugLine="CurrentValue = CurrentValue + Min(change, mVal";
...
RDebugUtils.currentLine=3473430;
 //BA.debugLineNum = 3473430;BA.debugLine="CurrentValue = CurrentValue - Min(change, Curr";
...
RDebugUtils.currentLine=3473433;
 //BA.debugLineNum = 3473433;BA.debugLine="LastTime = DateTime.Now";
_lasttime = parent.__c.DateTime.getNow();
RDebugUtils.currentLine=3473434;
 //BA.debugLineNum = 3473434;BA.debugLine="If CurrentValue < 100 Then";
if (true) break;
...
RDebugUtils.currentLine=3473435;
 //BA.debugLineNum = 3473435;BA.debugLine="tasks.Add(bc.AsyncDrawRectRounded(bc.TargetRect";
...
RDebugUtils.currentLine=3473437;
 //BA.debugLineNum = 3473437;BA.debugLine="If Vertical Then";
...
RDebugUtils.currentLine=3473438;
 //BA.debugLineNum = 3473438;BA.debugLine="r.Bottom = Round(CurrentValue / 100 * bc.mHeigh";
...
RDebugUtils.currentLine=3473440;
 //BA.debugLineNum = 3473440;BA.debugLine="r.Right = Round(CurrentValue / 100 * bc.mWidth)";
...
RDebugUtils.currentLine=3473443;
 //BA.debugLineNum = 3473443;BA.debugLine="tasks.Add(bc.AsyncDrawRectRounded(r, BusyBrush,";
...
RDebugUtils.currentLine=3473444;
 //BA.debugLineNum = 3473444;BA.debugLine="bc.DrawBitmapCreatorsAsync(Me, \"BC\", tasks)";
__ref._bc /*b4a.example.bitmapcreator*/ ._drawbitmapcreatorsasync(parent,"BC",_tasks);
RDebugUtils.currentLine=3473445;
 //BA.debugLineNum = 3473445;BA.debugLine="Wait For BC_BitmapReady (bmp As B4XBitmap)";
...
RDebugUtils.currentLine=3473446;
 //BA.debugLineNum = 3473446;BA.debugLine="If xui.IsB4J Then bmp = bc.Bitmap";
if (true) break;
...
RDebugUtils.currentLine=3473447;
 //BA.debugLineNum = 3473447;BA.debugLine="bc.SetBitmapToImageView(bmp, mIV)";
...
RDebugUtils.currentLine=3473448;
 //BA.debugLineNum = 3473448;BA.debugLine="Sleep(30)";
...
RDebugUtils.currentLine=3473450;
 //BA.debugLineNum = 3473450;BA.debugLine="End Sub";
if (true) break;
...
public String  _class_globals(anywheresoftware.b4a.samples.gps.anotherprogressbar __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="anotherprogressbar";
...
RDebugUtils.currentLine=3211269;
 //BA.debugLineNum = 3211269;BA.debugLine="Private BusyBrush As BCBrush";
_busybrush = new b4a.example.bcpath._bcbrush();
RDebugUtils.currentLine=3211270;
 //BA.debugLineNum = 3211270;BA.debugLine="Private BackgroundColor As Int";
_backgroundcolor = 0;
RDebugUtils.currentLine=3211271;
 //BA.debugLineNum = 3211271;BA.debugLine="Private BusyIndex As Int";
_busyindex = 0;
RDebugUtils.currentLine=3211272;
 //BA.debugLineNum = 3211272;BA.debugLine="Private bc As BitmapCreator";
_bc = new b4a.example.bitmapcreator();
RDebugUtils.currentLine=3211273;
 //BA.debugLineNum = 3211273;BA.debugLine="Private mIV As B4XView";
_miv = new anywheresoftware.b4a.objects.B4XViewWrapper();
RDebugUtils.currentLine=3211274;
 //BA.debugLineNum = 3211274;BA.debugLine="Private TransparentBrush As BCBrush";
_transparentbrush = new b4a.example.bcpath._bcbrush();
RDebugUtils.currentLine=3211275;
 //BA.debugLineNum = 3211275;BA.debugLine="Private Vertical As Boolean";
_vertical = false;
RDebugUtils.currentLine=3211276;
 //BA.debugLineNum = 3211276;BA.debugLine="Private CurrentValue As Float";
_currentvalue = 0f;
RDebugUtils.currentLine=3211277;
 //BA.debugLineNum = 3211277;BA.debugLine="Public EmptyColor As Int = xui.Color_White";
_emptycolor = __ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .Color_White;
RDebugUtils.currentLine=3211278;
 //BA.debugLineNum = 3211278;BA.debugLine="Private EmptyBrush As BCBrush";
_emptybrush = new b4a.example.bcpath._bcbrush();
RDebugUtils.currentLine=3211279;
 //BA.debugLineNum = 3211279;BA.debugLine="Private mValue As Int";
_mvalue = 0;
RDebugUtils.currentLine=3211280;
 //BA.debugLineNum = 3211280;BA.debugLine="Public Tag As Object";
_tag = new Object();
RDebugUtils.currentLine=3211281;
 //BA.debugLineNum = 3211281;BA.debugLine="Public ValueChangePerSecond As Float = 60";
_valuechangepersecond = (float) (60);
RDebugUtils.currentLine=3211282;
 //BA.debugLineNum = 3211282;BA.debugLine="Public CornerRadius As Int";
_cornerradius = 0;
RDebugUtils.currentLine=3211283;
 //BA.debugLineNum = 3211283;BA.debugLine="Public BrushOffsetDelta As Int = 3";
_brushoffsetdelta = (int) (3);
RDebugUtils.currentLine=3211284;
 //BA.debugLineNum = 3211284;BA.debugLine="End Sub";
return "";
}
public String  _designercreateview(anywheresoftware.b4a.samples.gps.anotherprogressbar __ref,Object _base,anywheresoftware.b4a.objects.LabelWrapper _lbl,anywheresoftware.b4a.objects.collections.Map _props) throws Exception{
__ref = this;
RDebugUtils.currentModule="anotherprogressbar";
...
RDebugUtils.currentLine=3342339;
 //BA.debugLineNum = 3342339;BA.debugLine="Dim iv As ImageView";
_iv = new anywheresoftware.b4a.objects.ImageViewWrapper();
RDebugUtils.currentLine=3342340;
 //BA.debugLineNum = 3342340;BA.debugLine="iv.Initialize(\"\")";
_iv.Initialize(ba,"");
RDebugUtils.currentLine=3342341;
 //BA.debugLineNum = 3342341;BA.debugLine="mIV = iv";
...
RDebugUtils.currentLine=3342342;
 //BA.debugLineNum = 3342342;BA.debugLine="mIV.Color = xui.Color_Transparent";
...
RDebugUtils.currentLine=3342343;
 //BA.debugLineNum = 3342343;BA.debugLine="setValue(Props.GetDefault(\"Value\", 100))";
__ref._setvalue /*String*/ (null,(int)(BA.ObjectToNumber(_props.GetDefault((Object)("Value"),(Object)(100)))));
RDebugUtils.currentLine=3342344;
 //BA.debugLineNum = 3342344;BA.debugLine="CurrentValue = mValue";
__ref._currentvalue /*float*/  = (float) (__ref._mvalue /*int*/ );
RDebugUtils.currentLine=3342345;
 //BA.debugLineNum = 3342345;BA.debugLine="mBase.AddView(mIV, 0, 0, 0, 0)";
...
RDebugUtils.currentLine=3342346;
 //BA.debugLineNum = 3342346;BA.debugLine="mBase.AddView(lbl, 0, 0, mBase.Width, mBase.Heigh";
...
RDebugUtils.currentLine=3342347;
 //BA.debugLineNum = 3342347;BA.debugLine="mBase.SetColorAndBorder(xui.Color_Transparent, 0,";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetColorAndBorder(__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .Color_Transparent,(int) (0),(int) (0),(int) (0));
RDebugUtils.currentLine=3342348;
 //BA.debugLineNum = 3342348;BA.debugLine="BackgroundColor = xui.PaintOrColorToColor(Props.G";
...
RDebugUtils.currentLine=3342349;
 //BA.debugLineNum = 3342349;BA.debugLine="CornerRadius = Props.GetDefault(\"CornerRadius\", 1";
...
RDebugUtils.currentLine=3342350;
 //BA.debugLineNum = 3342350;BA.debugLine="Base_Resize(mBase.Width, mBase.Height)";
__ref._base_resize /*String*/ (null,__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth(),__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight());
RDebugUtils.currentLine=3342351;
 //BA.debugLineNum = 3342351;BA.debugLine="End Sub";
return "";
}
public String  _setvalue(anywheresoftware.b4a.samples.gps.anotherprogressbar __ref,int _v) throws Exception{
__ref = this;
RDebugUtils.currentModule="anotherprogressbar";
if (Debug.shouldDelegate(ba, "setvalue", true))
	 {return ((String) Debug.delegate(ba, "setvalue", new Object[] {_v}));}
RDebugUtils.currentLine=3932160;
 //BA.debugLineNum = 3932160;BA.debugLine="Public Sub setValue (v As Int)";
RDebugUtils.currentLine=3932161;
 //BA.debugLineNum = 3932161;BA.debugLine="mValue = Max(0, Min(100, v))";
__ref._mvalue /*int*/  = (int) (__c.Max(0,__c.Min(100,_v)));
RDebugUtils.currentLine=3932162;
 //BA.debugLineNum = 3932162;BA.debugLine="End Sub";
return "";
}
public int  _getprogresscolor(anywheresoftware.b4a.samples.gps.anotherprogressbar __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="anotherprogressbar";
if (Debug.shouldDelegate(ba, "getprogresscolor", true))
	 {return ((Integer) Debug.delegate(ba, "getprogresscolor", null));}
RDebugUtils.currentLine=3538944;
 //BA.debugLineNum = 3538944;BA.debugLine="Public Sub getProgressColor As Int";
RDebugUtils.currentLine=3538945;
 //BA.debugLineNum = 3538945;BA.debugLine="Return BackgroundColor";
if (true) return __ref._backgroundcolor /*int*/ ;
RDebugUtils.currentLine=3538946;
 //BA.debugLineNum = 3538946;BA.debugLine="End Sub";
return 0;
}
public int  _getvalue(anywheresoftware.b4a.samples.gps.anotherprogressbar __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="anotherprogressbar";
...
RDebugUtils.currentLine=3866625;
 //BA.debugLineNum = 3866625;BA.debugLine="Return mValue";
if (true) return __ref._mvalue /*int*/ ;
RDebugUtils.currentLine=3866626;
 //BA.debugLineNum = 3866626;BA.debugLine="End Sub";
return 0;
}
public boolean  _getvisible(anywheresoftware.b4a.samples.gps.anotherprogressbar __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="anotherprogressbar";
if (Debug.shouldDelegate(ba, "getvisible", true))
	 {return ((Boolean) Debug.delegate(ba, "getvisible", null));}
RDebugUtils.currentLine=3801088;
 //BA.debugLineNum = 3801088;BA.debugLine="Public Sub getVisible As Boolean";
RDebugUtils.currentLine=3801089;
 //BA.debugLineNum = 3801089;BA.debugLine="Return mBase.Visible";
if (true) return __ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getVisible();
RDebugUtils.currentLine=3801090;
 //BA.debugLineNum = 3801090;BA.debugLine="End Sub";
return false;
}
public String  _initialize(anywheresoftware.b4a.samples.gps.anotherprogressbar __ref,anywheresoftware.b4a.BA _ba,Object _callback,String _eventname) throws Exception{
__ref = this;
innerInitialize(_ba);
RDebugUtils.currentModule="anotherprogressbar";
...
public String  _setprogresscolor(anywheresoftware.b4a.samples.gps.anotherprogressbar __ref,int _c) throws Exception{
__ref = this;
RDebugUtils.currentModule="anotherprogressbar";
if (Debug.shouldDelegate(ba, "setprogresscolor", true))
	 {return ((String) Debug.delegate(ba, "setprogresscolor", new Object[] {_c}));}
RDebugUtils.currentLine=3604480;
 //BA.debugLineNum = 3604480;BA.debugLine="Public Sub setProgressColor (c As Int)";
RDebugUtils.currentLine=3604481;
 //BA.debugLineNum = 3604481;BA.debugLine="BackgroundColor = c";
__ref._backgroundcolor /*int*/  = _c;
RDebugUtils.currentLine=3604482;
 //BA.debugLineNum = 3604482;BA.debugLine="UpdateGraphics";
__ref._updategraphics /*String*/ (null);
RDebugUtils.currentLine=3604483;
 //BA.debugLineNum = 3604483;BA.debugLine="End Sub";
return "";
}
public String  _setvaluenoanimation(anywheresoftware.b4a.samples.gps.anotherprogressbar __ref,int _v) throws Exception{
__ref = this;
RDebugUtils.currentModule="anotherprogressbar";
...
RDebugUtils.currentLine=3997696;
 //BA.debugLineNum = 3997696;BA.debugLine="Public Sub SetValueNoAnimation (v As Int)";
RDebugUtils.currentLine=3997697;
 //BA.debugLineNum = 3997697;BA.debugLine="setValue(v)";
__ref._setvalue /*String*/ (null,_v);
RDebugUtils.currentLine=3997698;
 //BA.debugLineNum = 3997698;BA.debugLine="CurrentValue = mValue";
__ref._currentvalue /*float*/  = (float) (__ref._mvalue /*int*/ );
RDebugUtils.currentLine=3997699;
 //BA.debugLineNum = 3997699;BA.debugLine="End Sub";
return "";
}
public String  _setvisible(anywheresoftware.b4a.samples.gps.anotherprogressbar __ref,boolean _b) throws Exception{
__ref = this;
RDebugUtils.currentModule="anotherprogressbar";
if (Debug.shouldDelegate(ba, "setvisible", true))
	 {return ((String) Debug.delegate(ba, "setvisible", new Object[] {_b}));}
RDebugUtils.currentLine=3735552;
 //BA.debugLineNum = 3735552;BA.debugLine="Public Sub setVisible(b As Boolean)";
RDebugUtils.currentLine=3735553;
 //BA.debugLineNum = 3735553;BA.debugLine="BusyIndex = BusyIndex + 1";
__ref._busyindex /*int*/  = (int) (__ref._busyindex /*int*/ +1);
RDebugUtils.currentLine=3735554;
 //BA.debugLineNum = 3735554;BA.debugLine="If b Then";
if (_b) { 
RDebugUtils.currentLine=3735555;
 //BA.debugLineNum = 3735555;BA.debugLine="BusyLoop";
__ref._busyloop /*void*/ (null);
 };
RDebugUtils.currentLine=3735557;
 //BA.debugLineNum = 3735557;BA.debugLine="mBase.Visible = b";
